  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          <p className="text-gray-300 mb-4 leading-relaxed font-handwriting text-lg">
          ...
          <p className="text-gray-300 leading-relaxed font-handwriting text-lg">
        ...
        >
          <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 border border-white/10 h-full flex flex-col justify-center">
            <div className="mb-4 text-center">
              <h3 className="text-xl font-heading font-bold mb-2 text-white">Tech Enthusiast</h3>
              <div className="w-full h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full"></div>
            </div>
            <div className="mb-4 text-center">
              <h3 className="text-xl font-heading font-bold mb-2 text-white">Problem Solver</h3>
              <div className="w-full h-1 bg-gradient-to-r from-green-500 to-blue-500 rounded-full"></div>
            </div>
            <div className="mb-4 text-center">
              <h3 className="text-xl font-heading font-bold mb-2 text-white">Creative Thinker</h3>
              <div className="w-full h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full"></div>
            </div>
            <div className="text-center">
              <h3 className="text-xl font-heading font-bold mb-2 text-white">Lifelong Learner</h3>
